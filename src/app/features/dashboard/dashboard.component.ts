        ...
        <div class="p-8 max-w-7xl mx-auto">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-8">
              ...
              <div class="flex items-start justify-between mb-4">
                <div class="w-10 h-10 rounded-xl flex items-center justify-center"
                  ...
                  <svg class="w-5 h-5"
                       ...
                       [class.text-slate-500]="!whatsappStatus()?.conectado"
                ...
                <span class="text-xs px-2 py-0.5 rounded-full border font-medium"
                      ...
                      [class.border-emerald-800]="whatsappStatus()?.conectado"
                      [class.bg-slate-800]="!whatsappStatus()?.conectado"
                      [class.text-slate-400]="!whatsappStatus()?.conectado"
                      [class.border-slate-700]="!whatsappStatus()?.conectado">
                  {{ whatsappStatus()?.conectado ? 'Online' : 'Offline' }}
                </span>
              </div>
              <p class="text-slate-400 text-xs uppercase tracking-widest mb-1">WhatsApp</p>
            ...
            <div class="bg-slate-900 border border-slate-800 hover:border-slate-700
              ...
              <p class="text-slate-400 text-xs uppercase tracking-widest mb-1">Enviadas</p>
              <p class="text-white font-semibold text-2xl">—</p>
              <p class="text-slate-600 text-xs mt-1">Conecte sua API para ver</p>
            </div>
            ...
            <div class="bg-slate-900 border border-slate-800 hover:border-slate-700
              ...
              <p class="text-slate-400 text-xs uppercase tracking-widest mb-1">Com Erro</p>
              <p class="text-white font-semibold text-2xl">—</p>
              <p class="text-slate-600 text-xs mt-1">Sem erros registrados</p>
            </div>
            ...
            <div class="bg-slate-900 border border-slate-800 hover:border-slate-700
              ...
              <p class="text-slate-400 text-xs uppercase tracking-widest mb-1">Canal Ativo</p>
              <p class="text-white font-semibold text-lg">WHATSAPP</p>
              <p class="text-slate-600 text-xs mt-1">Canal padrão configurado</p>
            </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <a routerLink="/whatsapp"
               class="group bg-slate-900 border border-slate-800 hover:border-indigo-500/40
              ...
              <div>
                <h3 class="text-white font-semibold">Gerenciar WhatsApp</h3>
                <p class="text-slate-500 text-sm mt-0.5">
                  Conecte, envie mensagens e veja o status da sessão
                </p>
              </div>
              <svg class="w-5 h-5 text-slate-600 group-hover:text-indigo-400 ml-auto
            ...
            <a routerLink="/notificacoes"
              ...
              <div>
                <h3 class="text-white font-semibold">Enviar Notificação</h3>
                <p class="text-slate-500 text-sm mt-0.5">
